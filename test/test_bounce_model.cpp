...
class RecordingBounceModel : public BounceModel
{
  public:
    ...
    {
        ++callCount_;
        lastSpinMagnitude_ = std::sqrt(state.spinVector[0] * state.spinVector[0] +
        ...
        (void)surface;
        return BounceResult{{0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 0.0F}};
    }
    ...
    float lastSpinMagnitude() const
    {
        return lastSpinMagnitude_;
    }
...
TEST(BounceModelInterfaceTest, CustomModelReceivesBounceCalls)
{
    ...
    LaunchData launch{.ballSpeedMph = 100.0F,
                      ...
                      .startY = 0.0F,
                      .startZ = 0.0F};
    AtmosphericData atmos{.temp = 70.0F,
                          .elevation = 0.0F,
                          .vWind = 0.0F,
                          .phiWind = 0.0F,
                          .hWind = 0.0F,
