...
{
    return RollState{{0.0F, 0.0F, 0.0F}, velocity, {0.0F, 0.0F, 0.0F}, normal, R, dt};
}
} // namespace
...
TEST(DefaultRollModelTest, FlatGroundDecelerates)
{
    ...
    auto result = model.step(makeState({10.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.1F), surface);
...
TEST(DefaultRollModelTest, DownhillAccelerates)
{
    ...
    auto result = model.step(makeState({0.0F, 1.0F, 0.0F}, normal, 0.1F), surface);
...
TEST(DefaultRollModelTest, UphillDecelerates)
{
    ...
    auto result = model.step(makeState({0.0F, 5.0F, 0.0F}, normal, 0.1F), surface);
...
TEST(DefaultRollModelTest, SteepSlopeAcceleratesSignificantly)
{
    ...
    auto result = model.step(makeState({0.0F, 2.0F, 0.0F}, normal, 0.1F), surface);
...
TEST(DefaultRollModelTest, DirectionPreservedAt45Degrees)
{
    ...
    auto result = model.step(makeState({10.0F, 10.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.1F), surface);
...
TEST(DefaultRollModelTest, AtRestWhenVelocityBelowStoppingThreshold)
{
    ...
    auto result = model.step(makeState({0.05F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.01F), surface);
...
TEST(DefaultRollModelTest, NotAtRestWhileMovingFast)
{
    ...
    auto result = model.step(makeState({15.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.01F), surface);
...
TEST(DefaultRollModelTest, SignFlipClampsToZero)
{
    ...
    auto result = model.step(makeState({0.2F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 1.0F), surface);
...
TEST(DefaultRollModelTest, NearZeroSlopeStartGetsAccelerated)
{
    ...
    auto result = model.step(makeState({0.0F, 0.02F, 0.0F}, normal, 0.01F), surface);
...
TEST(DefaultRollModelTest, SpinDecaysButPreservesAxis)
{
    ...
    RollState state{
        {0.0F, 0.0F, 0.0F}, {10.0F, 0.0F, 0.0F}, {500.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, R, 0.1F};
...
TEST(DefaultRollModelTest, SpinDecaysToZeroOverTime)
{
    ...
    RollState state{{0.0F, 0.0F, 0.0F},
                    {5.0F, 0.0F, 0.0F},
...
TEST(DefaultRollModelTest, ZeroVelocityProducesZeroAcceleration)
{
    ...
    auto result = model.step(makeState({0.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.1F), surface);
...
TEST(DefaultRollModelTest, HigherFrictionSlowsFaster)
{
    ...
    auto resultLow = model.step(makeState({20.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.1F), low);
    auto resultHigh = model.step(makeState({20.0F, 0.0F, 0.0F}, {0.0F, 0.0F, 1.0F}, 0.1F), high);
