...
class DefaultAerodynamicModel : public AerodynamicModel
{
  public:
                                                     ...
                                                     float liftScale) const
    {
        ...
        const double vw =
            std::sqrt(static_cast<double>(vRelX * vRelX + vRelY * vRelY + vRelZ * vRelZ));
    ...
    [[nodiscard]] double computeCd(double Re_x_e5, double spinFactor) const
    {
        ...
        {
            return cdLow - (cdLow - cdHigh) * (Re_x_e5 - reLow) / (reHigh - reLow) +
                   cdSpin * spinFactor;
        }
        else
        {
  ...
  private:
    ...
    {
        return static_cast<double>(CL_RE50K_A0) + static_cast<double>(CL_RE50K_A1) * S +
    ...
    {
        return static_cast<double>(CL_RE60K_A0) + static_cast<double>(CL_RE60K_A1) * S +
               static_cast<double>(CL_RE60K_A2) * S * S;
    }

    static double clRe65k(double S)
    {
        return static_cast<double>(CL_RE65K_A0) + static_cast<double>(CL_RE65K_A1) * S +
               static_cast<double>(CL_RE65K_A2) * S * S;
    }

    static double clRe70k(double S)
    {
        return static_cast<double>(CL_RE70K_A0) + static_cast<double>(CL_RE70K_A1) * S +
